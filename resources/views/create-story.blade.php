...
<form method="POST" action="/story" enctype="multipart/form-data">
    @csrf
    <label class="block">
      <span class="block text-sm font-medium text-slate-700 mb-3">Post Image/Video</span>
      <div>
        <span id='button' style="background-color: white; border: 5px; padding: 10px; cursor: pointer;">Select File Story</span>
    ...
    <button type="submit" class="bg-gradient-to-br from-pink-500 py-3 rounded-md text-white text-xl to-red-400 w-full">Posting Story</button>
  </form>
  </div>
  <script>
